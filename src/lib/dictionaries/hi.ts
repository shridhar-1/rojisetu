  ...
  kiosk: {
    ...
    chat: {
      ...
      retryNote: "कोई जवाब नहीं मिला। नेट जाँचें और फिर कोशिश करें।",
            voiceUnsupported: "इस ब्राउज़र में आवाज़ इनपुट समर्थित नहीं है। कृपया उत्तर लिखें।",
      micSpeak: "बोलकर उत्तर दीजिए",
      soundOn: "🔊 आवाज़ जवाब: चालू",
      soundOff: "🔈 आवाज़ जवाब: बंद",
    },
     voice: {
      statusListening: "सुन रहा है — अब बोलिए",
      statusThinking: "सोच रहा है…",
      statusSpeaking: "बोल रहा है — सुनिए",
      startVoice: "आवाज़ में बातचीत शुरू करें",
      exitVoice: "आवाज़ बंद करके वापस जाएं",
    },
    review: {
